...
namespace Pavel_Andrei_Lab8.Models
{
    public class BookCategoriesPageModel:PageModel
    {
        public List<AssignedCategoryData> AssignedCategoryDataList;
        public void PopulateAssignedCategoryData(Pavel_Andrei_Lab8Context context,Book book)
        {
        ...
        public void UpdateBookCategories(Pavel_Andrei_Lab8Context context,string[] selectedCategories, Book bookToUpdate)
        {
